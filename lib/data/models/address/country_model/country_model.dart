import 'package:api_servis_http/data/models/address/country_model/postal_code.dart';
...
class CountryModel {
  ...
  factory CountryModel.fromJson(Map<String, dynamic> json) {
    return CountryModel(
      ...
      tld: json["tld"] == null
          ? null
          : (json["tld"] as List?)?.map((e) => e as String).toList(),
      ...
      latlng: json["latlng"] == null
          ? null
          : (json["latlng"] as List).map((e) => e as num).toList(),
      ...
      currencies: (json['currencies'] as Map?)?.map((key, value) =>
          MapEntry<String, Currency>(key, Currency.fromJson(value))),
    );
  }
