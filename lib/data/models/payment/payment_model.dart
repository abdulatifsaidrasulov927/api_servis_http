...
class PaymentModel {
  ...
  PaymentModel(
      {required this.paymentIcon, required this.title, required this.price});

  factory PaymentModel.fromJson(Map<String, dynamic> json) {
    return PaymentModel(
        paymentIcon: json["paymentIcon"],
        title: json["title"],
        price: json["price"]);
  }
}
...
List<PaymentModel> payments = [
  PaymentModel(
      paymentIcon: AppIcons.myWallet, title: "My Wallet", price: 957.50),
  ...
  PaymentModel(
      paymentIcon: AppIcons.masterCard, title: ".... .... .... 4679", price: 0),
